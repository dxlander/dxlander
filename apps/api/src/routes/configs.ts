    ...
    .mutation(async ({ input, ctx }) => {
      try {
        ...
        if (!analysisId) {
          ...
          if (!latestAnalysis) {
            throw new Error('No completed analysis found for this project. Please run analysis first.')
          }
  ...
  list: protectedProcedure
    ...
    .query(async ({ input, ctx }) => {
      try {
        ...
        throw new Error(error.message || 'Failed to list configurations')
      }
    }),
  ...
  get: protectedProcedure
    ...
    .query(async ({ input, ctx }) => {
      try {
        ...
        throw new Error(error.message || 'Failed to retrieve configuration')
      }
    }),
