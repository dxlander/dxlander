...
export const components = {
  button: {
    ...
    variants: {
      default:
        'bg-gradient-to-r from-ocean-700 via-ocean-600 to-ocean-500 text-white shadow-lg hover:shadow-xl hover:shadow-ocean-500/30',
      secondary:
        'bg-gradient-to-r from-ocean-50 to-ocean-100 text-ocean-800 shadow-md hover:shadow-lg border border-ocean-200/50',
      outline:
        'border-2 border-ocean-200 bg-white/50 backdrop-blur-sm text-ocean-700 shadow-md hover:shadow-lg',
      ghost:
        'text-ocean-700 hover:bg-gradient-to-r hover:from-ocean-50 hover:to-ocean-100 hover:text-ocean-800',
    },
  },
  ...
  badge: {
    ...
    variants: {
      default:
        'border-transparent bg-gradient-to-r from-ocean-600 to-ocean-700 text-white shadow-md',
      secondary:
        'border-ocean-200/60 bg-ocean-50/80 text-ocean-700 hover:bg-ocean-100/80 backdrop-blur-sm',
  ...
  tabs: {
    ...
    trigger:
      'inline-flex items-center justify-center whitespace-nowrap rounded-lg px-4 py-2 text-sm font-semibold transition-all duration-300 ease-out cursor-pointer',
    triggerActive:
      'bg-gradient-to-r from-ocean-600 to-ocean-700 text-white shadow-lg shadow-ocean-500/30 scale-[1.02]',
  ...
  card: {
    ...
    variants: {
      default:
        'border-ocean-200/50 bg-white shadow-lg shadow-ocean-500/5 hover:shadow-xl hover:shadow-ocean-500/10',
      interactive:
        'border-ocean-200/60 bg-white shadow-ocean-500/10 hover:shadow-2xl hover:shadow-ocean-500/25 hover:scale-[1.02] cursor-pointer',
      elevated:
        'border-ocean-300/50 bg-ocean-50/30 shadow-2xl shadow-ocean-500/15 hover:shadow-3xl hover:shadow-ocean-500/25',
    },
  },
} as const;
