...
export interface AIProviderConfig {
  ...
  baseUrl?: string // For self-hosted (Ollama, LM Studio)
  model: string
...
export interface ProjectContext {
  ...
  onProgress?: AnalysisProgressCallback // Real-time progress callback
}
...
export interface IntegrationDetection {
  ...
  credentialType: 'api_key' | 'connection_string' | 'json_service_account' | 'oauth_token' | 'multiple' // Type of credentials needed
...
export interface AIProviderFactoryOptions {
  ...
  settings?: any
  decrypt: (encrypted: string) => string // Decryption function
}
